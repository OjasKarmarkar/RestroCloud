...
function OrderContainer() {
  ...
  return (
    <div className='fullpage w-full px-5 pt-[3rem] shadow-lg bg-slate-200 dark:bg-black dark:text-white'>
      ...
      <p className="pt-4 text-gray-400 text-lg">Review and check your delicious food before placing !</p>
        <div className='w-3/4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-2 border-solid border-2 border-gray-300 h-min bg-gray-200 dark:bg-black rounded-lg'>
